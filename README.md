## 🚀 B7Pizza (Projeto de Estudo B7Web)

Este repositório contém o código-fonte do B7Pizza, um sistema de delivery de pizzaria completo desenvolvido como projeto prático do curso da B7Web.

O principal objetivo foi aplicar na prática a criação de uma aplicação full-stack robusta, desde a interface do usuário até a conexão com o banco de dados.
